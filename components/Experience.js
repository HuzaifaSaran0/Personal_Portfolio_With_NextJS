...
const experiences = [
    {
        ...
        description:
            "Built scalable web applications and Telegram Bots for clients using React, Next.js, and Django. Integrated APIs, user authentication, and payment systems.",
        achievements: [
            "Developed 5+ web applications with a focus on performance and user experience",
            "Implemented RESTful APIs and integrated third-party services",
        ],
        technologies: ["Django", "Django-Rest-Framework", "Next.js", "PostgreSQL", "MySql", "TailwindCSS", "JWT", "Vercel", "Heroku"],
        type: "Full-time",
        current: true,
    },
    {
        role: "Python Game Developer Intern",
        company: "Brainox Pvt Ltd",
        location: "Millat Town, Faisalabad",
        period: "May 2024 - July 2024",
        description:
            "Developed and maintained Python-based games using Pygame and Turtle Python Libraries. Collaborated with designers to create engaging gameplay experiences.",
        achievements: [
            "Developed 3 interactive games using Pygame",
            "Improved game performance by 30% through code optimization",
            "Collaborated with development team",
        ],
        technologies: ["Python", "Turtle", "Pygame", "Git", "Github"],
        type: "Internship",
        current: false,
    },
    {
        ...
        description:
            "Developed Python Applications and Frontend projects using general web technologies. Focused on building scalable and efficient applications.",
        achievements: [
            "Built 3+ Python Projects with a focus on performance",
            "Optimized codebase leading to a 40% reduction in execution time",
        ],
